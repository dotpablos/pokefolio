...
export const PixelStyleButton = ({
  ...
  return (
    <button
      className="font-press-start-2p p-3 flex items-center bg-white text-black justify-center cursor-pointer min-w-24 relative border-3 border-black hover:bg-gray-400"
